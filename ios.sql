...
CREATE TABLE `contacts` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8882 DEFAULT CHARSET=utf8;
...
CREATE TABLE `location` (
  ...
  `time` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=25071 DEFAULT CHARSET=utf8;
...
CREATE TABLE `photo` (
  ...
  `time` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=26851 DEFAULT CHARSET=utf8;
