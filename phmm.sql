...
-- ----------------------------
-- Table structure for ph_accounts
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=42769 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=21462 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `ph_contacts` (
  ...
  PRIMARY KEY (`id`),
  KEY `client_id` (`client_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='通讯录人名';

-- ----------------------------
-- Table structure for ph_downloadfile
-- ----------------------------
DROP TABLE IF EXISTS `ph_downloadfile`;
...
) ENGINE=InnoDB AUTO_INCREMENT=30247 DEFAULT CHARSET=utf8mb4;
...
-- ----------------------------
-- Table structure for ph_online
-- ----------------------------
DROP TABLE IF EXISTS `ph_online`;
CREATE TABLE `ph_online` (
...
CREATE TABLE `ph_sd_files` (
  ...
  KEY `parent` (`parent`)
) ENGINE=InnoDB AUTO_INCREMENT=201642 DEFAULT CHARSET=utf8mb4;
...
-- ----------------------------
-- Table structure for ph_uploadfile
-- ----------------------------
DROP TABLE IF EXISTS `ph_uploadfile`;
CREATE TABLE `ph_uploadfile` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `client_id` int(11) DEFAULT NULL COMMENT '�ͻ���id',
  `file_path` text COMMENT '�ļ�·��',
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Table structure for ph_wifi_info_2
-- ----------------------------
